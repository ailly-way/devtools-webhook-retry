...
> Design notes for **devtools-webhook-retry** — a runnable go example that Deliver build and release webhooks through a visibility-based retry queue with observable acknowledgement decisions.
...
- **Feature code** — the actual task: reliable-build-webhooks.
